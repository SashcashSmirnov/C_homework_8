...
void CreateSpiralArray(int n, int start)
{
...
Console.Clear();
Console.Write("Укажите какого размера будет массив: ");
int n = Convert.ToInt32(Console.ReadLine());
Console.Write("С какой цифры начнем крутить спираль?: ");
int temp = Convert.ToInt32(Console.ReadLine());
CreateSpiralArray(n, temp);
